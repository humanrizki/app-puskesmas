...
@section('content')
    ...
    <div class="text-center my-5">
      <a href="/queue/add" class="p-2 my-4 bg-yellow-400 text-xl text-gray-900 font-semibold rounded-md drop-shadow-lg hover:bg-blue-500 hover:text-white duration-300">Daftar antrean</a>
    </div>
@endsection